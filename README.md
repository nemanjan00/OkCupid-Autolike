...
2. Copy the following snippet and paste it into the URL-Field: `javascript:(function(){document.body.appendChild(document.createElement('script')).src='https://rawgit.com/nemanjan00/OkCupid-Autolike-Autolike/master/OkCupid-Autolike-Autolike.user.js';})();`
...
2. Click this link to navigate to the script URL: https://raw.githubusercontent.com/nemanjan00/OkCupid-Autolike-Autolike/master/OkCupid-Autolike-Autolike.user.js
...
2. Copy the following snippet and paste it into the developer console on the TPP page: `javascript:(function(){document.body.appendChild(document.createElement('script')).src='https://rawgit.com/nemanjan00/OkCupid-Autolike-Autolike/master/OkCupid-Autolike-Autolike.user.js';})();`
